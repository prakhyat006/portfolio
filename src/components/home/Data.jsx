  ...
  return (
    <div>
      <div className="home__data">
        <h1 className="home__title">Prakhyat  
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                ...
                <p className="home__description">I am Very passionate about Solving tricky problems using creative thinking.
                    I also Enjoy Designing Things . 
                </p>
